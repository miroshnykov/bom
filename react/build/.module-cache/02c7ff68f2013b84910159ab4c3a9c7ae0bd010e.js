        ...
        switch (action.type) {
            ...
            case ActionConstants.CREATE_BOM:
                (function() {
                    ...
                    if (!this.validateAction(action, ["parentId", "name"])) {
                        return;
                    }
                    ...
                    parentBom = this.get(action.attributes.parentId);
                    if (!parentBom) {
                        return;
                    }
            ...
            case ActionConstants.REMOVE_BOM_COLUMN:
                (function() {
                    var bom;
                    var column;
            ...
            case ActionConstants.DESTROY_PRODUCT:
                ...
                (function() {
                    ...
                    rootBom = this.get(product.get("bomId"));

                    boms = [];
                    boms.push(rootBom);
                    boms = boms.concat(this.getDescendantBomsOfBom(rootBom.id || rootBom.cid));
                    this.remove(boms);
