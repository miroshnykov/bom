...
var BomImport = React.createClass({displayName: "BomImport",
    ...
    render: function() {
        ...
        if (this.state.alert) {
            importAlert = (
                React.createElement(Alert, {bsStyle: "warning", className: "col-md-8"}, this.state.alert));
        }
            ...
            importOptions = (React.createElement("div", {className: "bom-import-options clearfix"}, 
                    React.createElement("form", {className: "form-inline col-md-12"}, 
                        React.createElement("div", {className: "form-group"}, 
                            React.createElement("label", {htmlFor: "header"}, "Your file includes column names"), 
                        ...
                        React.createElement("div", {className: "form-group"}, 
                            React.createElement("label", {htmlFor: "delimiter"}, "Your values are separated by"), 
                        ...
                        React.createElement("div", {className: "form-group"}, 
                            React.createElement("label", {htmlFor: "encoding"}, "Your file is encoded as"), 
                ...
                React.createElement("div", {className: "wrapper"}, 
                    ...
                    React.createElement("div", {className: "row col-lg-6 col-md-8 col-sm-12"}, 
                        ...
                        React.createElement("div", null, 
                            React.createElement(ButtonToolbar, {className: "col-md-4"}, 
                                React.createElement(Button, {
                                    bsStyle: "primary", 
                                    bsSize: "large", 
