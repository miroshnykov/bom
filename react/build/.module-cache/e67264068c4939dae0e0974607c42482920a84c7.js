...
var Profile = React.createClass({displayName: "Profile",
    ...
    */
    render: function() {
        ...
        var usernameElement;
        var usernamePlaceholder = "How should we display your name to others?";
            ...
            profileGroup = (
                React.createElement("div", null, 
                    ...
                    React.createElement("div", {className: "form-group"}, 
                        ...
                        React.createElement("div", {className: "col-xs-8"}, 
                            React.createElement("input", {ref: "usernameInput", type: "text", label: "Display Name", className: "form-control", value: this.state.username, placeholder: usernamePlaceholder, onBlur: this._onBlurUsername, onChange: this._onChangeUsername, onKeyDown: this._onKeyDownUsername})
                        )
                    ), 
                    React.createElement("div", {className: "form-group"}, 
                        React.createElement("label", {className: "control-label col-xs-4"}, 
            ...
            profileGroup = (
                React.createElement("div", null, 
                    ...
                    React.createElement("div", {className: "form-group"}, 
                        ...
                        React.createElement("div", {className: "col-xs-8"}, 
                            this.state.username ?
                                (React.createElement("div", {className: "control-content"}, this.state.username)) :
                                (React.createElement("div", {className: "control-content placeholder"}, usernamePlaceholder))
                        )
                    ), 
                    React.createElement("div", {className: "form-group"}, 
                        React.createElement("label", {className: "control-label col-xs-4"}, 
    ...
    _onSaveProfile: function(event) {
        ...
        UserActions.update({
            ...
            username: this.state.username !== profile.username ? this.state.username : undefined,
            ...
            this.setState({ profileAlert: error.errorThrown });
        }.bind(this));
    },
    ...
    _onSaveEmail: function(event) {
        ...
        UserActions.update({
            ...
            this.setState({ emailAlert: error.errorThrown });
        }.bind(this));
    },
    ...
    _onSavePassword: function(event) {
        ...
        UserActions.update({
            ...
            this.setState({ passwordAlert: error.errorThrown });
        }.bind(this));
    },
    ...
    _onKeyDownLastname: function(event) {
        if (event.keyCode === InputConstants.ENTER_KEY_CODE) {
            ...
            this.refs.usernameInput.getDOMNode().select();
        }
    },

    // Display/User Name

    _onBlurUsername: function(event) {
    ...
    _onKeyDownUsername: function(event) {
        if (event.keyCode === InputConstants.ENTER_KEY_CODE) {
