        ...
        switch (action.type) {
            ...
            case ActionConstants.UPDATE_BOM_ITEM:
                (function() {
                    ...
                    if (!bom || !item || !value || !attribute) { return; }

                    //TODO break that down into four methods

                    //queue revision
                    this.push({
                        name: "Updated " + value.id + " to " + value.get("content"),
                        request: function() {
                            var json;
                            ...
                            if (item.isNew()) {
                                ...
                                return item.save(undefined, { attrs: json });
                            }
                            else if (value.isNew()) {
                                json = value.toJSON();
                                ...
                                return value.save(undefined, { attrs: json });
                            }
                            ...
                            //TODO need to fix attribute ids
                        }
                    });
                ...
                (function() {
                    ...
                    this.push({
                        ...
                        request: function() {
                            ...
                            if (newField) {
                                attrs = _.extend( _.omit(attribute.toJSON(), 'fieldId'), {
                                    typeId: typeId
                                });
                            }
                            else {
                                attrs = attribute.toJSON();
                            }

                            return attribute.save(undefined, { attrs: attrs });
                        }
                    });
                }).apply(this);
                break;
            ...
            case ActionConstants.SET_BOM_COLUMN:
                (function() {
                    ...
                    //queue revision
                    this.push({
                        name: "Changed column to " + attribute.get("name"),
                        request: function() {
            ...
            case ActionConstants.HIDE_BOM_COLUMN:
                (function() {
                    ...
                    //queue revision
                    this.push({
                        name: "Hide column " + attribute.name,
                        request: function() {
                            return attribute.save(
                                undefined,
                                {
