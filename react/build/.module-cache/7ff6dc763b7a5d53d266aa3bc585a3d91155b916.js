...
var BomManager = React.createClass({displayName: "BomManager",
    ...
    componentDidMount: function() {
        UserActions.fetch().then(function(user) {
            ...
            ProductStore.on("request", this._onRequest);
            ...
            BomStore.on("request request:items request:attributes request:values", this._onRequest);
            ...
            // ChangeStore.on("request", this._onRequest);
            ...
            // FieldStore.on("request", this._onRequest);
            ...
            // FieldTypeStore.on("request", this._onRequest);
            ...
            // BomImportStore.on("request", this._onRequest);
    ...
    componentWillUnmount: function() {
        ...
        ProductStore.off("request", this._onRequest);
        ...
        BomStore.off("request request:items request:attributes request:values", this._onRequest);
        ...
        // ChangeStore.off("request", this._onRequest);
        ...
        // FieldStore.off("request", this._onRequest);
        ...
        // FieldTypeStore.off("request", this._onRequest);
        ...
        // BomImportStore.off("request", this._onRequest);
