...
var RevisionList = require("../components/RevisionList.react");
    ...
    _renderOpen: function() {
        ...
        switch(this.state.view) {
            case 'products':
                ...
                footer = (React.createElement(Button, {bsStyle: "link", onClick: this._showHistory}, React.createElement("h3", null, "History")));
                break;

            case 'history':
                panel = (React.createElement(RevisionList, {
                    allRevisions: this.props.allRevisions}));

                footer = (React.createElement(Button, {bsStyle: "link", onClick: this._showProducts}, React.createElement("h3", null, "Products")));
                break;
        ...
        return (
            React.createElement("div", {className: "sidepanel sidepanel-left sidepanel-left-open col-md-2"}, 
