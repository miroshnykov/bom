...
jest.dontMock("../../../lib/jquery.nicescroll");
...
jest.mock("../../collections/BomItemCollection");
...
describe("Bom.react", function() {
    ...
    it("exports and opens modal the bom items when _onExport is called", function() {
        instance.refs.component._getHeadersForFieldSet = jest.genMockFunction().mockImplementation(function() {
            return [
