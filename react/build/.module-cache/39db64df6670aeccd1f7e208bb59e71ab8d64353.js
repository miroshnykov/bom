...
describe("BomModel", function() {
    ...
    it("gets an item", function() {
        ...
        expect(item.toJSON()).toEqual(testBom.items[0]);
    });
    ...
    it("gets of all items", function() {
        ...
        expect(items.toJSON()).toEqual(testBom.items);
    });
    ...
    it("removes an item", function() {
        bom.removeItem(1);
        expect(bom.getItems().toJSON()).toEqual([testBom.items[1], testBom.items[2]]);
    });

    it("removes multiple items", function() {
        bom.removeItems([1, 2]);
        expect(bom.getItems().toJSON()).toEqual([testBom.items[2]]);
    });
