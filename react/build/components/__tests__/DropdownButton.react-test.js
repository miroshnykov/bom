jest.dontMock("../DropdownButton.react.js");

describe("DropdownButton.react", function() {
  ...
  it("renders button correctly", function() {
    instance = TestUtils.renderIntoDocument(
      React.createElement(DropdownButton, {id: "test", glyphicon: "caret"}, 
    ...
    expect(button.lastChild.className).toMatch(/\bglyphicon-caret\b/);
  });
  ...
  it("renders menu with pullRight when pullRight property is set to true", function() {
    instance = TestUtils.renderIntoDocument(
      React.createElement(DropdownButton, {pullRight: true}, 
        React.createElement(MenuItem, {eventKey: "1"}, "MenuItem 1 content"), 
        React.createElement(MenuItem, {eventKey: "2"}, "MenuItem 2 content")
      )
    );
  ...
  it("calls MenuItem onSelect with correct arguments when MenuItem is clicked", function() {
    ...
    instance = TestUtils.renderIntoDocument(
      React.createElement(DropdownButton, null, 
        React.createElement(MenuItem, {eventKey: "1"}, "MenuItem 1 content"), 
        React.createElement(MenuItem, {eventKey: "2", href: "testHref", target: "testTarget", onSelect: callback}, "MenuItem 2 content")
      )
    );
