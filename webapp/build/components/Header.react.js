    ...
    render: function() {
        ...
        React.createElement("header", null, 
            React.createElement("div", {className: "col-md-6"}, 
                React.createElement(Link, {to: "app"}, React.createElement("div", {className: "logo"}))
            ), 
        ...
        return (React.createElement("div", {className: "col-md-6 text-right header-right"}, 
                ...
                React.createElement("div", {className: "menu"}, 
                    ...
                    React.createElement(DropdownButton, {id: "dropdown-user-menu", glyphicon: "option-vertical", pullRight: true}, 
                        React.createElement(MenuItem, {eventKey: "/profile", onSelect: this.transitionTo}, "Profile"), 
                        React.createElement(MenuItem, {eventKey: "/company/invite", onSelect: this.transitionTo}, "Invite Users"), 
