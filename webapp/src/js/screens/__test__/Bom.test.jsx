...
describe("Bom", function() {
    ...
    beforeEach(function() {
        ...
        BomStore.collection.getDescendantBomsOfBom = jest.genMockFunction().mockReturnValue( [] );

        BomStore.collection.get = jest.genMockFunction().mockImplementation(function() {
        ...
        ProductStore.collection.get = jest.genMockFunction().mockImplementation(function() {
        ...
        BomStore.collection.get = jest.genMockFunction().mockReturnValue( undefined );
        ...
        instance = React.render(<Wrapper />, container);
    });
    ...
    it("exports and opens modal the bom items when _onExport is called", function() {
        ...
        instance.refs.component._getBom = jest.genMockFunction().mockImplementation(function() {
            ...
            model.isLoading = jest.genMockFunction().mockReturnValue( false );
            model.isLoaded = jest.genMockFunction().mockReturnValue( true );
